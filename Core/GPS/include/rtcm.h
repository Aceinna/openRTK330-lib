...
// #ifdef WIN32
// #define MAXOBS   70                      /* max number of observed satellites */
// #else
...
//#define _PC_
#ifdef _PC_
#define MAXEPH      100                     /* max number of GPS/BDS/GAL ephemeris(PC) */
#define MAXEPH_R    24                      /* max number of GLO ephemeris(PC) */
#else
