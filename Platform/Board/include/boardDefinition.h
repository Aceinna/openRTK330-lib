...
#define USER_UART3_RX_PIN                       GPIO_PIN_7
#define USER_UART3_RX_PORT                      GPIOE
#define USER_UART3_RX_GPIO_CLK_ENABLE()         __HAL_RCC_GPIOE_CLK_ENABLE()

#define USER_UART3_TX_PIN                       GPIO_PIN_8
#define USER_UART3_TX_PORT                      GPIOE
#define USER_UART3_TX_GPIO_CLK_ENABLE()         __HAL_RCC_GPIOE_CLK_ENABLE()
